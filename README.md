...
This project implements a dictionary data structure using a trie. The main functionalities include inserting words into the dictionary, searching for words, and suggesting correct words in case of typos.
